...
const messages = {
  tr: {
    ...
    community: {
      eyebrow: '03 /',
      title: 'Topluluk sinyalleri',
      note:
        'Örnek veriler / gerçek topluluk ölçümü değildir',
      tabsLabel: 'Topluluk sinyali görünümleri',
      cards: [
        {
          type: 'effort',
          code: '01 /',
          label: 'İş arama eforu',
          eyebrow: 'Başvurudan teklife',
          title: '1 teklif için ortalama 72 başvuru gerekiyor.',
          description: 'Başvuru, dönüş, görüşme ve teklif sayılarını birlikte okuyarak iş arama sürecindeki gerçek eforu görünür hale getiriyoruz.',
          ...
          chartAria: '72 başvurudan 28 dönüş, 8 görüşme ve 1 teklif oluşuyor.',
          stages: [
            { label: 'Başvuru', value: '72', share: '100%' },
            { label: 'Dönüş', value: '28', share: '39%' },
        ...
        },
        {
          type: 'reliability',
          code: '02 /',
          label: 'Süreç güvenilirliği',
          eyebrow: 'Şirket yanıt davranışı',
          title: 'Her 10 başvurunun 4’ü yanıtsız kalıyor.',
          description: 'Zamanında dönüş, gecikme, otomatik ret ve yanıtsızlık aynı dağılım içinde birbirinden ayrılıyor.',
          summary: 'Sessizlik ile otomatik ret aynı sonuç değil; ayrı ölçülüyor.',
          path: '/surveys/company-experience',
          cta: 'Şirket deneyimini paylaş',
          ...
          distribution: responseStatuses.tr,
          metrics: [
            { value: '%58', label: 'Söz verildi, dönüş yapılmadı' },
            { value: '%12', label: 'Elenme sebebi paylaşıldı' },
          ],
        },
        {
          type: 'heatmap',
  ...
  en: {
    ...
    community: {
      ...
      tabsLabel: 'Community signal views',
      cards: [
        {
          type: 'effort',
          code: '01 /',
          label: 'Job-search effort',
          eyebrow: 'Application to offer',
          title: 'It takes an average of 72 applications to receive one offer.',
          description: 'Applications, responses, interviews, and offers reveal the real effort inside a job search when read together.',
        ...
        },
        {
          ...
          eyebrow: 'Company response behavior',
          title: 'Four out of every 10 applications receive no response.',
          description: 'Timely responses, delays, automated rejections, and silence are separated within one distribution.',
          summary: 'Silence and automated rejection are different outcomes and are measured separately.',
          path: '/surveys/company-experience',
          cta: 'Share a company experience',
