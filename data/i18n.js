  ...
  tr: {
    ...
    home: {
      hero: {
        ...
        problem: 'Başvuruların otomatik reddediliyor, yanıtsız kalıyor veya süreç içinde kayboluyor mu?',
        descriptionParts: {
          pre: 'Deneyimlerini ',
          highlight: 'anonim',
  ...
  en: {
    ...
    home: {
      hero: {
        ...
        problem: 'Are your applications automatically rejected, left unanswered, or lost in the process?',
        descriptionParts: {
          pre: 'Compare your experiences ',
