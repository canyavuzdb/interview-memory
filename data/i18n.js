      ...
      signal: {
        ...
        views: [
          ...
          },
          {
            ...
            distribution: [
              { label: '7 gün içinde insan yanıtı', value: '%34', width: '34%', tone: 'timely' },
              { label: 'Geç insan yanıtı', value: '%13', width: '13%', tone: 'late' },
              { label: 'Otomatik ret', value: '%12', width: '12%', tone: 'rejected' },
              { label: 'Hiç yanıt yok', value: '%41', width: '41%', tone: 'silent' },
            ],
          },
        ],
      ...
      signal: {
        ...
        views: [
          ...
          },
          {
            ...
            distribution: [
              { label: 'Human response within 7 days', value: '34%', width: '34%', tone: 'timely' },
              { label: 'Late human response', value: '13%', width: '13%', tone: 'late' },
