  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'lib/intake/{contracts,errors}.ts',
        'lib/privacy/{contracts,errors}.ts',
        'lib/public-benchmark/{contracts,errors}.ts',
        ...
        'lib/server/public-benchmark/{repository,service}.ts',
        'lib/server/security/{crypto,policy,repository,respondent,service}.ts',
        'lib/server/search-benchmark/{actor,repository,service}.ts',
