...
export default function StepProcessReview({
  ...
  return (
    <div className="space-y-7">
      ...
      <details className="border-t border-[var(--line-strong)] pt-5">
        <summary className="cursor-pointer text-sm font-semibold text-ink marker:text-accent">
          {copy.optionalDetails.title}
        </summary>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted">{copy.optionalDetails.description}</p>
